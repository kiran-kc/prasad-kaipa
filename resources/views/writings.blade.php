            ...
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-12 writing-box">
                ...
                <!-- card 2 -->
                 <div class="row writing-card">
                    <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1 writing-cardRow">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 writing-content" id="card2">
                ...
                <!-- card 3  --> 
                 <div class="row writing-card">
                    <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1 writing-cardRow">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 writing-content" id="card3">
                ...
                <!-- card 4 -->
                 <div class="row writing-card">
                    <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1 writing-cardRow">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 writing-content" id="card4">
                ...
                <div class="row writing-card">
                    <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1 writing-cardRow">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 writing-content" id="card5">
                ...
                <div class="row writing-card">
                    <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1 writing-cardRow">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 writing-content" id="card6">
