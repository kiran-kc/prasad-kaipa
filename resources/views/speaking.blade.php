		...
		<div class="row videos-container">
			<div class="col-lg-5 col-lg-offset-1 col-md-5 col-md-offset-1 col-sm-5 col-sm-offset-1 videos-gridLayout">
				...
				<div class="videos-title">
		 			...
		 			<h4>Dr. Kaipa explains that appreciative inquiry, honesty and authenticity trumps forced changes, every time.</h4>
		 		</div>
			</div>
			<div class="col-lg-5 col-md-5 col-sm-5 videos-gridLayout" align="right">
				...
				<div class="videos-title" align="left">
		 			<h3><strong>Dr. Kaipa on Generation Leader</strong></h3>
		...
		<div class="row videos-container">
			<div class="col-lg-4 col-lg-offset-1 col-md-4 col-md-offset-1 col-sm-4 col-sm-offset-1 videos-gridLayout" align="left">
				...
				<div class="videos-title">
		 			...
		 			<h4>Dr. Kaipa's take on two extreme styles of Leadership.</h4>
		 		</div>
			</div>
...
<!--================ video 6 Row 4 =============================-->		
		<div class="row videos-container">
			<div class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 videos-gridLayout" align="left">
				...
				<div class="videos-title">
		 			<h3><strong>Dr Prasad Kaipa At The Happiness Hall Of Fame</strong></h3>
...
<!--================ video 7 and 8 Row 5 =============================-->			
		<div class="row videos-container">
			<div class="col-lg-6 col-lg-offset-1  col-md-6 col-md-offset-1 col-sm-6 col-sm-offset-1  videos-gridLayout" align="left">
				...
				<div class="videos-title">
		 			<h3><strong>Dr Prasad Kaipa At School of Inspired Leadership</strong></h3>
		 			<h4>Dr. Kaipa shares insights on Leadership, Innovation in modern times and his life's journey with students.</h4>
		 		</div>
			</div>
			<div class="col-lg-4 col-md-4 col-sm-4 videos-gridLayout" align="right">
				...
				<div class="videos-title" align="left">
		 			...
		 			<h4>Dr. Kaipa evaluates systems one operates from.</h4>
		 		</div>
			</div>
		</div>	
